...
impl Scheme for Scheme02 {
    ...
    fn validate(&self, to_hash: &crate::pwd::ContentToHash, pwd_ref: &str) -> Result<()> {
        ...
        argon2
            ...
            .map_err(|_| Error::PasswordValidate)
    }
}
...
fn get_argon2() -> &'static Argon2<'static> {
    ...
    INSTANCE.get_or_init(|| {
        ...
        Argon2::new_with_secret(
            key,
            Algorithm::Argon2d, // Same as Argon2::default().
...
mod tests {
    ...
    fn test_scheme_02_hash_into_b64u_ok() -> Result<()> {
        ...
        let fx_res = "$argon2d$v=19$m=19456,t=2,p=1$8F6JYdatQIaeeKbeBl5UUw$gTuZPML/udPRt4rbis15FBYaTl0yHhaO7wqB1/q6224";
        // ---- Execute.
        let scheme = Scheme02;
